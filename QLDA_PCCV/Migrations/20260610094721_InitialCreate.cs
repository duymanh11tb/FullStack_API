    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OnComment = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OnAssigned = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OnStatusChanged = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OnMention = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OnSprintStarted = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OnMemberAdded = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
